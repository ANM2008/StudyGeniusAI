...
export default function FlashcardsClient({ params }: Props) {
    ...
    const nextCard = () => {
        ...
        if (currentCardIndex < topicFlashcards.length - 1) {
            ...
            setNeedToReview(needToReview.slice(1));
        } else {
        ...
        <div className="container py-10">
            ...
            {!practiceMode ? (
                ...
                <>
                    ...
                    <div className="flex justify-between mt-4" style={{
                        display: 'flex',
                        flexDirection: 'row',
                        ...
                        {!showAnswer ? (
                            ...
                            <>
                                ...
                                <Button onClick={markLearned} variant="default" style={{ backgroundColor: 'green', color: 'white' }}>Learned</Button>
                            </>
                        )}
