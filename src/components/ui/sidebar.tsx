...
function SidebarNavigation({ className, navItems }: SidebarProps) {
  ...
  return (
    <AlertDialog open={isLogoutDialogOpen} onOpenChange={setIsLogoutDialogOpen}>
      <div
        className={cn(
          "hidden lg:flex lg:flex-col lg:w-64 lg:border-r lg:bg-background lg:h-full",
          className
        )}
      >
        <div className="flex flex-col flex-grow p-4 space-y-4">
          <div className="flex items-center justify-center h-16 border-b">
            <h1 className="text-2xl font-semibold">ActiveRecall</h1>
          </div>
...
export {
  SidebarNavigation as SidebarNav,
  SidebarContent,
  SidebarFooter,
  SidebarGroup,
  SidebarGroupAction,
